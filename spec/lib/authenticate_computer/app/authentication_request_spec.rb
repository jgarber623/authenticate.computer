describe AuthenticateComputer::App, 'when performing an Authentication Request' do
  ...
  before do
    ...
    get '/auth', me: me, client_id: client_id, redirect_uri: redirect_uri, state: state, scope: '', response_type: 'id'
